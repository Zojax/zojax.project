...
from zojax.workflow.interfaces import IWorkflowInfo, IWorkflowState
from zojax.resourcepackage.library import include

from zojax.project.interfaces import _
from zojax.project.interfaces import ITask, ITaskAssignee, ITaskAttributes
...
class ITaskCommentAdapter(interface.Interface):
    ...
    transition = RadioChoice(
        title = u'Status',
        description = u'Select task status.',
        vocabulary = 'content.workflow.transitions',
        required = False)
